...
namespace DynamicFormWPF.Classes_Data
{
    ...
    public class FileDisplayBindingList<T> : BindingList<T>
    {
        ...
        private Action<FileDisplayBindingList<T>, List<T>>
        ...
        public FileDisplayBindingList()
        {
            originalList = new List<T>();
        }

        public FileDisplayBindingList(IEnumerable<T> enumerable)
        {
            originalList = enumerable.ToList();
            populateBaseList(this, originalList);
        }

        public FileDisplayBindingList(List<T> list)
        {
            originalList = list;
            populateBaseList(this, originalList);
        }
